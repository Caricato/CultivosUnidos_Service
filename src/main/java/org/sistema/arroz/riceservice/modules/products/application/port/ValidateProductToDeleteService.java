...
import org.sistema.arroz.riceservice.modules.products.domain.ProductNotValidToDeleteException;
...
public class ValidateProductToDeleteService implements ValidateProductToDeleteUseCase {
    ...
    public void validateProduct(Long productId) {
        ...
        if (!result.isEmpty()) throw new ProductNotValidToDeleteException(productId);
    }
}
